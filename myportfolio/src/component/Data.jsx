export const Data = {
  ...
  "technicalSkills": {
    ...
    "tools": ["Github", "Postman", "J-meter", "Figma"],
  ...
  "experience": [
    ...
    },
    {
      ...
      "responsibilities": [
        ...
        "Worked with technologies including JavaScript, React, Jest, HTML/CSS, Git, and Postman."
      ]
    },
    {
    ...
    {
      "title": "Network Developer Intern",
      "company": "Ageis i-net Institute",
      "location": "Jabalpur (M.P.)",
      "duration": "April 2018 – Jan 2019",
      "role": "Network Engineer",
      "responsibilities": [
        "Assisted as a Network Engineer in designing infrastructure.",
        "Troubleshot technical issues and supported documentation."
      ]
    }
  ],
  "projects": [
      ...
      "para": [
        {
          "id": 1,
          "title": "Overview",
          "text": "This E-Commerce Platform is a full-fledged web application that allows users to browse, search, and purchase products online with secure user authentication and product management features.",
          "isList": "false",
          "list": null
        },
        {
          "id": 2,
          "title": "Project Goal",
          "text": "The goal was to simulate a real-world shopping experience by implementing key e-commerce functionalities like product catalog, shopping cart, user registration, and order placement.",
          "isList": "false",
          "list": null
        },
        {
